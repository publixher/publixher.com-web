var svgIconConfig = {
	clock : { 
		url : '/plugins/AnimatedSVGIcons-master/svg/clock.svg',
		animation : [
			{ 
				el : 'path:nth-child(2)', 
				animProperties : { 
	...
	trash : { 
		url : '/plugins/AnimatedSVGIcons-master/svg/trash.svg',
		animation : [
			{ 
				el : 'path:nth-child(1)', 
				animProperties : { 
	...
	contract : { 
		url : '/plugins/AnimatedSVGIcons-master/svg/contract.svg',
		animation : [
			{ 
				el : 'rect:nth-child(2)', 
				animProperties : { 
	...
	maximize : { 
		url : '/plugins/AnimatedSVGIcons-master/svg/maximize.svg',
		animation : [
			{ 
				el : 'path:nth-child(1)', 
				animProperties : { 
	...
	volume : {
		url : '/plugins/AnimatedSVGIcons-master/svg/volume.svg',
		animation : [
			{ 
				el : 'path:nth-child(1)', 
				animProperties : { 
	...
	plus : { 
		url : '/plugins/AnimatedSVGIcons-master/svg/plus.svg',
		animation : [
			{ 
				el : 'path:nth-child(1)', 
				animProperties : { 
	...
	hamburger : {
		url : '/plugins/AnimatedSVGIcons-master/svg/hamburger.svg',
		animation : [
			{ 
				el : 'path:nth-child(1)', 
				animProperties : { 
	...
	navLeftArrow : {
		url : '/plugins/AnimatedSVGIcons-master/svg/nav-left-arrow.svg',
		animation : [
			{ 
				el : 'path', 
				animProperties : { 
	...
	navUpArrow : {
		url : '/plugins/AnimatedSVGIcons-master/svg/nav-up-arrow.svg',
		animation : [
			{ 
				el : 'path', 
				animProperties : { 
	...
	rightArrow : {
		url : '/plugins/AnimatedSVGIcons-master/svg/right-arrow.svg',
		animation : [
			{ 
				el : 'path', 
				animProperties : { 
	...
	downArrow : {
		url : '/plugins/AnimatedSVGIcons-master/svg/down-arrow.svg',
		animation : [
			{ 
				el : 'path', 
				animProperties : { 
	...
	smiley : {
		url : '/plugins/AnimatedSVGIcons-master/svg/smiley.svg',
		animation : [
			{ 
				el : 'path', 
				animProperties : { 
	...
	play : {
		url : '/plugins/AnimatedSVGIcons-master/svg/play.svg',
		animation : [
			{ 
				el : 'path', 
				animProperties : { 
	...
	mail : {
		url : '/plugins/AnimatedSVGIcons-master/svg/mail.svg',
		animation : [
			{ 
				el : 'path', 
				animProperties : { 
	...
	equalizer : {
		url : '/plugins/AnimatedSVGIcons-master/svg/equalizer.svg',
		animation : [
			{ 
				el : 'path:nth-child(1)', 
				animProperties : { 
	...
	glass : {
		url : '/plugins/AnimatedSVGIcons-master/svg/glass.svg',
		animation : [
			{ 
				el : 'path', 
				animProperties : { 
	...
	hourglass : {
		url : '/plugins/AnimatedSVGIcons-master/svg/hourglass.svg',
		animation : [
			{ 
				el : 'path:nth-child(1)', 
				animProperties : { 
	...
	padlock : {
		url : '/plugins/AnimatedSVGIcons-master/svg/padlock.svg',
		animation : [
			{ 
				el : 'path', 
				animProperties : { 
	...
	zoom : {
		url : '/plugins/AnimatedSVGIcons-master/svg/zoom.svg',
		animation : [
			{ 
				el : 'path:nth-child(1)', 
				animProperties : { 
	...
	monitor : {
		url : '/plugins/AnimatedSVGIcons-master/svg/monitor.svg',
		animation : [
			{ 
				el : 'path', 
				animProperties : { 
	...
	flag : {
		url : '/plugins/AnimatedSVGIcons-master/svg/flag.svg',
		animation : [
			{ 
				el : 'path', 
				animProperties : { 
