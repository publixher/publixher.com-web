<div id="left">
    ...
    <div class="accordion" id="subslist">구독목록<br>
        ...
        $sql4 = "SELECT USER_NAME,PIC,USER.ID,FOLLOW.LAST_CHECK,FOLLOW.LAST_UPDATE FROM publixher.TBL_USER USER INNER JOIN publixher.TBL_FOLLOW FOLLOW ON FOLLOW.ID_MASTER=USER.ID WHERE FOLLOW.ID_SLAVE=:ID_SLAVE";
