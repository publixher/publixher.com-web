<div id="left">
    <div class="accordion" id="subslist">구독목록<br>
        ...
        $sql4 = "SELECT USER_NAME,PIC,USER.SEQ FROM publixher.TBL_USER USER INNER JOIN publixher.TBL_FOLLOW FOLLOW ON FOLLOW.SEQ_MASTER=USER.SEQ WHERE FOLLOW.SEQ_SLAVE=:SEQ_SLAVE";
