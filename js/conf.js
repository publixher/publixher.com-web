                    ...
                    for (var i = 0; i < res.length; i++) {
                        switch (res[i]['ACT']) {
                            case '1':
                                ...
                                $('#notilist li:last-child').after('<li><div class="noti-img-wrap"><img class="noti-img" src="'+res[i]['PIC']+'"></div><a href="/content/' + res[i]['ID_CONTENT'] + '">' + word + '</a></li>');
                                break;
                            case '2':
                                var word = res[i]['USER_NAME'] + '님이 회원님과 친구가 되고싶어 합니다.';
                                $('#notilist li:last-child').after('<li><div class="noti-img-wrap"><img class="noti-img" src="'+res[i]['PIC']+'"></div><a href="/profile/' + mid + '">' + word + '</a></li>');
                                break;
                            case '3':
