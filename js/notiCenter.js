            ...
            success: function (res) {
                ...
                if (res[1]) {
                    ...
                    for (var i = 0; i < title.length; i++) {
                        ...
                        listul.append('<li><a href="/php/getItem.php?iid=' + res[1][title[i]][0]['ID_CONTENT'] + '">' + word + '</a><span class="notidate">'+res[1][title[i]]['date']+'</span></li>');
                    }
                }
                if (res[2]) {
                ...
                if (res[3]) {
                    ...
                    for (var i = 0; i < title.length; i++) {
                        ...
                        listul.append('<li><a href="/php/getItem.php?iid=' + res[3][title[i]][0]['ID_CONTENT'] + '">' + word + '</a><span class="notidate">'+res[3][title[i]]['date']+'</span></li>');
                    }
                }
                if (res[4]) {
                    ...
                    for (var i = 0; i < title.length; i++) {
                        ...
                        listul.append('<li><a href="/php/getItem.php?iid=' + res[4][title[i]][0]['ID_CONTENT'] + '">' + word + '</a><span class="notidate">'+res[4][title[i]]['date']+'</span></li>');
                    }
                }
                if (res[6]) {
                    ...
                    for (var i = 0; i < reply.length; i++) {
                        ...
                        listul.append('<li><a href="/php/getItem.php?iid='+ res[6][reply[i]][0]['ID_CONTENT'] + '">' + word + '</a><span class="notidate">'+res[6][reply[i]]['date']+'</span></li>');
                    }
                }
                if (res[7]) {
                    ...
                    for (var i = 0; i < reply.length; i++) {
                        ...
                        listul.append('<li><a href="/php/getItem.php?iid='+ res[7][reply[i]][0]['ID_CONTENT'] + '">' + word + '</a><span class="notidate">'+res[7][reply[i]]['date']+'</span></li>');
                    }
                }
                page=page+1;
            }
