...
//이미지는 허용
$config->set('HTML.Allowed','img[src|class],a[class],br,div,p,span[class|data-userid],iframe[src|allowfullscreen|width|height|frameborder]');
...
$def->addAttribute('span','data-userid','Text');
